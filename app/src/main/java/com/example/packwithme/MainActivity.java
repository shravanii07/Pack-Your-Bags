...
import com.example.packwithme.Adapter.AdapterTest;
import com.example.packwithme.Constants.MyConstants;
import com.example.packwithme.Data.AppData;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new AdapterTest(this,titles, images,MainActivity.this);
    ...
    public void onBackPressed() {
        if(mBackPressed+TIME_INTERVAL>System.currentTimeMillis()){
            ...
            Toast.makeText(this, "Tap back butten in order to exit", Toast.LENGTH_SHORT).show();
        }
    ...
    private void persistAppData(){
        ...
        if(!prefs.getBoolean(MyConstants.FIRST_TIME_CAMEL_CASE,false)){
            ...
            database.mainDao().deleteAllByItems(MyConstants.SYSTEM_SMALL);
