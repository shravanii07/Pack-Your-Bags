package com.example.packwithme.Adapter;
...
import com.example.packwithme.CheckList;
import com.example.packwithme.Constants.MyConstants;
import com.example.packwithme.R;
...
public class AdapterTest extends RecyclerView.Adapter<AdapterTest.myViewHolder>{
    ...
    public AdapterTest(Context context, List<String> titles, List<Integer> images, Activity activity) {
        this.titles = titles;
        this.images = images;
