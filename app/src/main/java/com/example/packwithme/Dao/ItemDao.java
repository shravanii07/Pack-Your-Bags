package com.example.packwithme.Dao;
...
public interface ItemDao {
    ...
    @Query("select * from items where category=:categogy order by id asc")
    List<Items> getAll(String categogy);
    ...
    Integer deleteAllByItems(String addedBy);
...
//    void deleteAllSystemItems(String systemSmall);
}
